...
[OkHttp 省略 INFO com.fengxuan.chatgpt.*****istener - OpenAI建立sse连接...
[OkHttp 省略 INFO com.fengxuan.chatgpt.*****istener - OpenAI返回数据：{"choices":[{"delta":{"role":"assistant"},"index":0,"finish_reason":null}]}
[OkHttp 省略 INFO com.fengxuan.chatgpt.*****istener - OpenAI返回数据：{"choices":[{"delta":{"content":"Ser"},"index":0,"finish_reason":null}]}
[OkHttp 省略 INFO com.fengxuan.chatgpt.*****istener - OpenAI返回数据：{"choices":[{"delta":{"content":"end"},"index":0,"finish_reason":null}]}
[OkHttp 省略 INFO com.fengxuan.chatgpt.*****istener - OpenAI返回数据：{"choices":[{"delta":{"content":"ip"},"index":0,"finish_reason":null}]}
[OkHttp 省略 INFO com.fengxuan.chatgpt.*****istener - OpenAI返回数据：{"choices":[{"delta":{"content":"ity"},"index":0,"finish_reason":null}]}
[OkHttp 省略 INFO com.fengxuan.chatgpt.*****istener - OpenAI返回数据：{"choices":[{"delta":{},"index":0,"finish_reason":"stop"}]}
[OkHttp 省略 INFO com.fengxuan.chatgpt.*****istener - OpenAI返回数据：[DONE]
[OkHttp 省略 INFO com.fengxuan.chatgpt.*****istener - OpenAI返回数据结束了
[OkHttp 省略 INFO com.fengxuan.chatgpt.*****istener - OpenAI关闭sse连接...
```
